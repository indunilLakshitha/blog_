          ...
          <div class="container">
            <div class="row align-items-center ">
              <div class="col-md-5 mt-5 pt-5">
                <span class="text-cursive h5 text-red">ආඩුයිනෝ එක්ක රොබොටික්ස් ඉගෙනගමුද ?</span>
                <h1 class="mb-3 font-weight-bold text-teal">ආඩුයිනෝ එක්ක රොබොටික්ස් ඉගෙනගමුද ?</h1>
                <p>Amazing Playground for your kids</p>
                <p class="mt-5"><a href="#" class="btn btn-primary py-4 btn-custom-1">Learn More</a></p>
              </div>
              <div class="col-md-6 ml-auto align-self-end">
                <img src="{{asset('front/images/kid_transparent.png')}}" alt="Image" class="img-fluid">
          ...
          <div class="row">
            <div class="col-lg-4 mb-4 mb-lg-0">
              <div class="package text-center bg-white">
                <span class="img-wrap"><img src="{{asset('front/images/flaticon/svg/001-jigsaw.svg')}}" alt="Image" class="img-fluid"></span>
            ...
            <div class="col-lg-4 mb-4 mb-lg-0">
              <div class="package text-center bg-white">
                <span class="img-wrap"><img src="{{asset('front/images/flaticon/svg/002-target.svg')}}" alt="Image" class="img-fluid"></span>
            ...
            <div class="col-lg-4 mb-4 mb-lg-0">
              <div class="package text-center bg-white">
                <span class="img-wrap"><img src="{{asset('front/images/flaticon/svg/003-mission.svg')}}" alt="Image" class="img-fluid"></span>
                ...
                <div class="owl-carousel nonloop-block-13">
                  <div class="testimonial-3 d-flex">
                    <div class="vcard-wrap mr-5">
                      <img src="{{asset('front/images/person_1.jpg')}}'" alt="Image" class="vcard img-fluid">
                    </div>
                    <div class="text">
                      <h3>Jeff Woodland</h3>
                  ...
                  <div class="testimonial-3 d-flex">
                    <div class="vcard-wrap mr-5">
                      <img src="{{asset('front/images/person_3.jpg')}}" alt="Image" class="vcard img-fluid">
                    </div>
                    <div class="text">
                      <h3>Jeff Woodland</h3>
                      <p class="position">Partner</p>
                  ...
                  <div class="testimonial-3 d-flex">
                    <div class="vcard-wrap mr-5">
                      <img src="{{asset('front/images/person_2.jpg')}}" alt="Image" class="vcard img-fluid">
                    </div>
                    <div class="text">
                      <h3>Jeff Woodland</h3>
                      <p class="position">Partner</p>
